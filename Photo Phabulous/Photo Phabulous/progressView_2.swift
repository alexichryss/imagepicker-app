// Attribution: https://github.com/Isuru-Nanayakkara/IJProgressView/blob/master/IJProgressView/IJProgressView/IJProgressView.swift
//
...
open class IJProgressView {
    ...
    open func showProgressView(_ view: UIView) {
        ...
        containerView.backgroundColor = UIColor(hex: 0x333333, alpha: 0.2)
